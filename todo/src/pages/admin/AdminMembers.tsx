      ...
      <main className="p-4 sm:p-8 max-w-7xl mx-auto w-full space-y-6">
        ...
        {loading ? (
            ...
            {filteredMembers.length === 0 ? (
                ...
                <Card key={member._id} className="border-none shadow-xl shadow-gray-200/40 hover:shadow-2xl hover:-translate-y-1 transition-all group overflow-hidden bg-white rounded-[2.5rem] cursor-pointer" onClick={() => navigate(`/admin/members/${member._id}`)}>
                ...
                <CardContent className="pt-12 pb-8 px-8">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button
                            ...
                            onClick={(e) => { e.stopPropagation(); navigate(`/admin/members/${member._id}`); }}
                        >
                            View Profile
                        </Button>
                    </div>
